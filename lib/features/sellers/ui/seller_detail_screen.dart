...
class SellerDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) {
        ...
        cubit.loadSellerDetail(sellerId);
        return cubit;
      },
              ...
              child: BlocBuilder<SellerCubit, SellerState>(
                builder: (context, state) {
                  if (state is SellerDetailLoading) {
                    ...
                    return _buildDetailContent(context, state.seller);
          ...
          child: Center(
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    context.read<SellerCubit>().loadSellerDetail(sellerId);
                  },
  ...
  Widget _buildDetailContent(BuildContext context, Seller seller) {
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: StandaloneChatButton(
                            targetUserId: seller.id.toString(),
                            targetUserName: seller.workshopName.isNotEmpty
                                ? seller.workshopName
                                : seller.name,
                            targetUserImage: seller.imageUrlString.isNotEmpty
                                ? seller.imageUrlString
                                : null,
                          ),
                        ),
                      ],
                  ...
                  // Image
                  if (seller.imageUrlString.isNotEmpty)
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  // Phone
                                  InkWell(
                                    onTap: () => _makePhoneCall(seller.phone),
                                    child: Container(
                                          ...
                                          Expanded(
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                SizedBox(height: 4.h),
                                                Text(
                                                  '${seller.city.isNotEmpty ? seller.city : ''}${seller.city.isNotEmpty && seller.state.isNotEmpty ? ' - ' : ''}${seller.state.isNotEmpty ? seller.state : ''}',
                                                  style: TextStyle(
                                                    fontSize: 16.sp,
                                                    fontWeight: FontWeight.w600,
                                                    color:
                                  ...
                                  SizedBox(height: 12.h),
                                  AddCommentWidget(
                                    commentableUserId: seller.id,
                                    onCommentAdded: () {
                                      context.read<SellerCubit>().loadSellerDetail(sellerId);
                                    },
                                  ),
                                  SizedBox(height: 16.h),
                                  if (seller.comments.isEmpty)
                                    Text(
